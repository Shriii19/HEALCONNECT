            ...
            <ul className="w-full flex flex-col mx-auto px-2 py-2">
              ...
              <li key={'Setting'}>
                <Link href="/admin/setting">
                  <div
                    className={`sidebar-icon group ${router.asPath === "/admin/setting" && "bg-blue-500 dark:bg-blue-500 text-white"
                      }`}
                  >
                    <FaCog size={28} />
                    <span className="sidebar-tooltip group-hover:scale-100">
              ...
              <li key={'Doctors'}>
                <Link href="/admin/doctors">
                  <div
                    className={`sidebar-icon group ${router.asPath === "/admin/doctors" && "bg-blue-500 dark:bg-blue-500 text-white"
                      }`}
                  >
                    <FaUsers size={28} />
                    <span className="sidebar-tooltip group-hover:scale-100">
